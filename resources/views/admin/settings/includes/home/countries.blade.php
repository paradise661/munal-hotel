<div class="tab-pane fade" id="countries" role="tabpanel">
    ...
    <fieldset class="border p-3">
        <legend class="float-none w-auto legend-title">Rooms Section</legend>
        <div class="row">
            <div class="mb-4 col-md-6">
                <label for="countries_title" class="form-label">Rooms Title</label>
                <input type="text" class="form-control" id="countries_title" name="countries_title"
                    placeholder="Country Title" value="{{ $settings['countries_title'] }}" />
            ...
            <div class="mb-4 col-md-6">
                <label for="countries_subtitle" class="form-label">Rooms Subtitle</label>
            ...
            <div class="mb-4">
                <label for="countries_description" class="form-label">Rooms Description</label>
                <textarea class="form-control" id="countries_description" name="countries_description"
                    placeholder="Country Description" rows="4">{{ $settings['countries_description'] }}</textarea>
            ...
            {{-- <div class="mb-4 col-md-6">
                <label for="countries_button" class="form-label">Rooms Button Text</label>
            ...
            {{-- <div class="mb-4 col-md-6">
                ...
                <input type="text" class="form-control" id="countries_link" name="countries_link"
                    placeholder="Country Link" value="{{ $settings['countries_link'] }}" />
            ...
            {{-- <div class="mb-4">
                ...
                <select name="home_countries[]" id="home_countries" multiple>
                    ...
                    <option value="{{ $Country->id }}" @if (in_array($Country->id, $selectedcountriesIds)) selected
                        @endif>
