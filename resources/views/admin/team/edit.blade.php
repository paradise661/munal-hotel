                    ...
                    <div class="card ">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="description" name="description" placeholder="Description" rows="4">{{ old('description', ${$name}->description) }}</textarea>
                                @error('description')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="facebook" name="facebook"
                                    placeholder="facebook" value="{{ old('facebook', $team->facebook) }}" />
                                @error('facebook')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="twitter" name="twitter"
                                    placeholder="twitter" value="{{ old('twitter', $team->twitter) }}" />
                                @error('twitter')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
