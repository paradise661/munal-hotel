                    ...
                    <div class="card ">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="description" name="description" placeholder="Description" rows="10">{{ old('description') }}</textarea>
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="facebook" name="facebook"
                                    placeholder="Facebook" value="{{ old('position') }}" />
                                @error('facebook')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="twitter" name="twitter"
                                    placeholder="Twitter" value="{{ old('position') }}" />
                                @error('twitter')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
