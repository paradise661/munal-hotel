...
@section('content')
        ...
        <div class="flex justify-between text-sm">
            ...
            <span id="summary-checkin" class="font-semibold text-gray-800">Select date</span>
        </div>
        <div class="flex justify-between text-sm">
            <span class="text-gray-600">Check-out</span>
            <span id="summary-checkout" class="font-semibold text-gray-800">Select date</span>
        </div>
        <div class="flex justify-between text-sm">
            <span class="text-gray-600">Guests</span>
            <span id="summary-guests" class="font-semibold text-gray-800">
                0 Adults, 0 Children
            </span>
        </div>
    </div>
