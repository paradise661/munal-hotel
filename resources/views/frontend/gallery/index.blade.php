                    ...
                    @foreach ($albums as $album)
                        @foreach ($album->galleries as $gallery)
                            <div class="gallery-item {{ $album->slug }} group cursor-pointer"
                                ...
                                <a class="fro-dropzone-image-a fancybox" data-fancybox="gallery" data-caption="{{ $gallery->title }}"
                                    href="{{ $gallery->image }}">
                                    <div class="relative overflow-hidden rounded-xl h-80">
                                        <img class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 fro-dropzone-image-img"
