...
@section('content')
    ...
    <section class="py-16 bg-gray-50" id="amenities-grid">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
                ...
                @foreach ($complete_amenities as $amenity)
                    <div class="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <div
                            ...
                            <img class="w-10 h-10 object-contain" src="{{ asset($amenity->image) }}"
                                alt="{{ $amenity->title }}">
                        </div>
                        <!-- Title -->
    ...
    <section class="py-16 bg-luxury-cream" id="dining-amenities">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-playfair font-bold text-luxury-dark mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow"
                    ...
                    <div class="h-48 overflow-hidden">
                        <img class="w-full h-full object-cover hover:scale-110 transition-transform duration-500"
                            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/dc39e35ff7-ee83143ea8497949b76a.png"
                            alt="elegant fine dining restaurant interior, sophisticated table settings, ambient lighting, luxury hotel dining" />
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-playfair font-bold text-luxury-dark mb-2">Aurelius</h3>
                        <p class="text-gray-600 mb-4">Michelin-starred fine dining featuring contemporary European cuisine
                            crafted by renowned chefs.</p>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow"
                    ...
                    <div class="h-48 overflow-hidden">
                        <img class="w-full h-full object-cover hover:scale-110 transition-transform duration-500"
                            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/b6e1b75f6f-32d2005a4df7c6b38fdc.png"
                            alt="modern rooftop bar, city skyline view, elegant cocktail lounge, contemporary design, evening atmosphere" />
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-playfair font-bold text-luxury-dark mb-2">Sky Lounge</h3>
                        <p class="text-gray-600 mb-4">Rooftop bar offering craft cocktails and panoramic city views in an
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow"
                    ...
                    <div class="h-48 overflow-hidden">
                        <img class="w-full h-full object-cover hover:scale-110 transition-transform duration-500"
                            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/6ab85b4ff3-9daefc83dca1bb355920.png"
                            alt="casual elegant cafe interior, comfortable seating, natural lighting, modern breakfast restaurant design" />
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-playfair font-bold text-luxury-dark mb-2">Garden Café</h3>
                        <p class="text-gray-600 mb-4">All-day dining featuring fresh, locally-sourced ingredients in a
                            relaxed garden setting.</p>
                        <div class="flex items-center justify-between">
    ...
    <section class="py-16" id="amenities-hours">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="bg-luxury-cream rounded-2xl p-8" id="contact-amenities">
                    <h3 class="text-2xl font-playfair font-bold text-luxury-dark mb-6">Plan Your Visit</h3>
                    <p class="text-gray-600 mb-6">
                        Our concierge team is available to help you make the most of our amenities and plan your perfect
                        stay.
                    </p>
                    ...
                    <button
                        class="w-full border-2 border-luxury-gold text-luxury-gold py-3 rounded-lg font-semibold hover:bg-luxury-gold hover:text-white transition-colors">
                        Book Amenities
                    </button>
                </div>
            </div>
