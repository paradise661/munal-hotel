    ...
    public function run(): void
    {
        $branches = [
            ...
            [
                'order' => 1,
                'status' => 1,
                'title' => 'Ideal Education Educare Lagankhel',
                'short_description' => 'Ideal Education Educare branch in Lagankhel, near Mangal Bazaar.',
            ...
            [
                'order' => 2,
                'status' => 1,
                'title' => 'Ideal Education Educare Itahari',
                'short_description' => 'Ideal Education Educare branch in Itahari, offering educational services.',
            ...
            [
                'order' => 3,
                'status' => 1,
                'title' => 'Ideal Education Educare Damak',
                'short_description' => 'Ideal Education Educare branch in Damak, opposite Global IME Bank.',
            ...
            [
                'order' => 4,
                'status' => 1,
                'title' => 'Ideal Education Educare Biratnagar',
                'short_description' => 'Ideal Education Educare branch in Biratnagar at Mahendra Chowk.',
            ...
            [
                'order' => 5,
                'status' => 1,
                'title' => 'Ideal Education Educare Kathmandu',
                'short_description' => 'Ideal Education Educare branch in Kathmandu near Chabahil Stupa.',
